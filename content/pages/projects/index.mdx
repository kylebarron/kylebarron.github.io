...
All my projects are available at [Github](https://github.com/kylebarron).
...
<GithubLink
  languages={["py", "ts"]}
  href="https://github.com/developmentseed/lonboard"
/>
...
Python bindings to the core `geoarrow-rs` library implementing the GeoArrow specification with efficient spatial operations.

### GeoPolars

<GithubLink
  languages={["rust", "py", "js"]}
  href="https://github.com/geopolars/geopolars"
/>
...
Python bindings to [`hmm`](https://github.com/fogleman/hmm) for fast terrain mesh generation. I figured out _just enough_ C++ to connect `hmm` to pybind11.
...
### [nst-guide/naip](https://nst-guide.github.io/naip)
...
### [nst-guide/fstopo](https://nst-guide.github.io/fstopo)
...
### [nst-guide/contours](https://nst-guide.github.io/contours)
...
### [naip-cogeo-mosaic](https://kylebarron.dev/naip-cogeo-mosaic/)
...
<GithubLink
  languages={["ts"]}
  href="https://github.com/kylebarron/arrow-js-ffi"
/>
...
Geospatial extensions for the Polars DataFrame library.

### geo-index

<GithubLink
  languages={["rust"]}
  href="https://github.com/kylebarron/geo-index"
/>
...
<GithubLink
  languages={["rust"]}
  href="https://github.com/kylebarron/arrow-wasm"
/>
...
### [OSM Liberty Topo](https://nst-guide.github.io/osm-liberty-topo)
...
### [All Transit](https://all-transit.com)
