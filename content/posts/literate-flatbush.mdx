...
Because the post uses a different theme, it is hosted _directly_ by Github pages at (<a href="https://kylebarron.dev/literate-flatbush/" target="_blank" rel="noopener noreferrer">https://kylebarron.dev/literate-flatbush/</a>), and embedded below:
